...
if (sessionStorage.getItem('bodyClass')) {
    body.setAttribute('class', sessionStorage.getItem('bodyClass'))
}

toogleTheme.addEventListener('change', () => {
    body.classList.toggle('dark')

    // Store class current in sessionStorage
    sessionStorage.setItem('bodyClass', body.getAttribute('class'))
})
